...
filename_in <- "Results/C_AD/matrix_DEG.txt"

filename_list_case <-"Data/caseAD.txt"
filename_list_control <-"Data/control.txt"

file_score_plot = paste0(dirC_AD, "score_plot.pdf")
file_pareto_scree_plot = paste0(dirC_AD,"pareto_screen_plot.pdf")
file_contribution_plot = paste0(dirC_AD,"PC_contibution_plot.pdf")
...
groups = c(rep("AD", length(list_case)), rep("control", length(list_control)))
